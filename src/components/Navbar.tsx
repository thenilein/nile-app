...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className="hidden md:flex items-center justify-between px-6 md:px-10 py-5 border-b border-gray-100 bg-white">
            ...
            <nav className="flex md:hidden items-center justify-between px-4 h-[60px] bg-[#16a34a]">
                {/* Left: Logo */}
                <Link to="/" className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-[#16a34a] font-bold text-lg leading-none pt-0.5">
                        N
                    </div>
                ...
                {/* Right: Location Pill + User */}
                <div className="flex items-center gap-3">
                    {showLocationPill && (
                        <button
                            onClick={handleChangeLocation}
                            className="flex items-center gap-1.5 bg-white/20 rounded-full px-2.5 py-1"
                        >
                            <span className="text-[11px]">📍</span>
                            <span className="text-[11px] font-semibold text-white max-w-[70px] truncate">
                                {locationData.displayName}
                            </span>
                        </button>
                    )}
