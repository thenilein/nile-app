-- Migration 005: Bypass Signup Rate Limit helper
-- This function creates a dummy user in auth.users directly, 
-- bypassing the strict 3-per-hour signup rate limit for demo purposes.
